...
export const Header = () => {
    ...
    const {cart, vaciarCart, totalCart, contadorProductos, onDeleteProduct} = useContext(CartContext)
                                ...
                                <div className="row-product">
                                    ...
                                    {cart.map(prod => (
                                        ...
                                        <div className="info-cart-product">
                                            ...
                                            <p className="titulo-producto-carrito">{prod.nombre}</p>
                                    ...
                                    <button className='btn-clear-all' onClick={vaciarCart}>Vaciar Carrito</button>
                                    </>      
                                    ): (
